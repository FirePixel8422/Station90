...
{
    /// <summary>
    /// Uitlity class to have an optimized easy acces to Update Callbacks by using an Action based callback system
    /// </summary>
...
#pragma warning restore UDR0004
        ...
        /// <summary>
        /// Gets called once in the next LateUpdate 
        /// </summary>
        /// <param name="action"></param>
        public static void RegisterLateOnDestroy(Action action)
        {
#pragma warning disable UDR0004
...
#pragma warning restore UDR0004
        ...
        public static void RegisterLateOnApplicationQuit(Action action)
        {
#pragma warning disable UDR0004
